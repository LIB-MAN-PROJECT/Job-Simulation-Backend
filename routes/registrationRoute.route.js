...
const { signup, login,newSignUp } = require("../controllers/authController.controller");
...
router.post("/newsignup",validateSchema(signupSchema),
// #swagger.tags = ['Users','Recruiters','Admins']
// #swagger.summary = 'New Sign Up (Untested)'
newSignUp);
